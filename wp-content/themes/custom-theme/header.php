...
<div class="site-wrap" style="background-image: url('<?php echo get_template_directory_uri() . "/assets/images/home/homepage-bg.png"; ?>');background-attachment: fixed;background-position: center center;background-size: cover;">
<section class="menu-desktop"> 
	<div class="container" style="border-bottom: 2px solid #06663a;">
...
<section class="menu-mobile"> 
	<div class="container" style="border-bottom: 2px solid #06663a;">
		...
		<div class="col-xs-10 left header-logo" style="padding-top: 10px;margin-left: 10px;">
			<a href="<?php echo get_option('home'); ?>">
				<?php the_custom_logo(); ?>
			</a>
		</div>
